...
------------------------------------------------------------------------------------------------------------------
 ...
 - end=""   Me permite unir el print() que esta arriba con el print() de abajo. Tambien cuenta con comillas que me permiten escribir dentro, se puede poner un "espacio" para que la ultima palabra del texto de arriba no este pegado a la primera de abajo
...
# En este ejercio trataremos de hacer la sucesion de Fibonacci hasta el numero 1597.
# Pero se hara con un limite de 7 linias de codigo como maximo.




numero_1, numero_2 = 0, 1     #Estoy declarando dos variables distintas en una misma linia.  Es lo mismo que declarar:    numero_1 = 0     Esto lo hago para ahorrar linias de codigo
                                                                                                              #           numero_2 = 1                              
                              # El 0 y el 1 son los numeros con los que se inicia la sucecion de Figonacci

while numero_2 <= 1597  :     # Puse numero_2 porque el valor mas grande siempre lo va a tener esta variable.
    
    print (numero_1, numero_2, end=" ") #Se imprimen los numeros de arriba y luego del loop, se imprimen los numeros de abajo si es que cumplen con la condicion de ser <= a 1597. Por eso puse el print() aca y no abajo del todo 
    
    numero_1 += numero_2   #A la variable 1 se le "suma" el valor de la variable 2. Dandole un nuevo valor a la variable 1      

    numero_2 += numero_1   #Ojo con esto. A la variable 2 se le "suma" el "nuevo valor" de la variable 1. Dandole un nuevo valor a la variable 2 
