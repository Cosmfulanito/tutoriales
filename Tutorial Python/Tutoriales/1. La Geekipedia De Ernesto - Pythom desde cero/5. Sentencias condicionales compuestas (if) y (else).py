...
#_____SENTECIAS CONDICIONALES COMPUESTAS:_____

# Este programa va a ser la misma calculadora de diviciones que el el programa pasado, pero con el agregado del condicional "else"

# Basicament es lo mismo que lo anterior, con elo agregado del condicional "else".
# Cuando se da el caso de que la condicion del "if" es falsa, se puede aplicar el "else" para dar una instruccion.



print ("_____SENTECIAS CONDICIONALES COMPUESTAS:_____")
...
else :                                 # Cuando se da el caso de que la condicion del "if" es falsa, se puede aplicar el "else" para dar una instruccion.    ":" Le indica al programa que se tiene que se tiene que prepararse para leer la instruccion que se tiene que ejecutar en caso dado de que la condicion loguica del "if" no se cumpla 
    print ("¿Como vas dividir por Cero? ¡La concha de tu hermana!")   # Esto es la orden que da el "else" en caso que el "if" no se cumpla
