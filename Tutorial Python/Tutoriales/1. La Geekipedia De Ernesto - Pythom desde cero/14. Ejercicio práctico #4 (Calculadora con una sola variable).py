...
# Este es un ejercicio donde solo se pueden poner 2 valores por operacion matematica. Peeeeero, este programa solo debe funcionar con una unica variable, la variable "numero". No se permiten otras variables mas.
...
while True:
    ...
    try:
        ...
        if numero == 1 :
            ...
            numero += int (input ("Introduce el segundo numero: "))   # Ya tengo un valor en la variable numero ya que lo hice mas arriba. Ahora gracias al += el segundo numero introducido se suma al valor de la variable que ya tengo. El valor de la suma reemplaza al valor anterior    
            ...
            numero = int (input ("Introduce el primer numero: "))
            numero /= int (input ("Introduce el segundo numero: "))
            print ("El resultado de la divicion es", round(numero, 2))   # El roun( ,2) hace que los numeros tengasn solamente 2 decimales como maximo. Es mejor 10/3= 3.33  que  10/3=3.3333333333333333       

        elif numero == 5 :
            print ("Elegiste Divivion entera\n")
            numero = int (input ("Introduce el primer numero: "))
            numero //= int (input ("Introduce el segundo numero: "))
            ...
            numero = int (input ("Introduce el primer numero: "))
            numero **= int (input ("Introduce el segundo numero: "))
            print ("El resultado de elevar al exponente es", numero)

        elif numero == 7 :
            print ("Elegiste Modulo/resto\n")
            numero = int (input ("Introduce el primer numero: "))
            numero %= int (input ("Introduce el segundo numero: "))
            print ("El resultado del del Modulo/resto es", numero)
