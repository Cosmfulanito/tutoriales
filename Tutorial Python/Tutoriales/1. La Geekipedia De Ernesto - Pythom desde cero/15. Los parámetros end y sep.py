...
print ("Esto es un", end=" ") # El parametro end="" me permite unir el texto que esta arriba con el de abajo. Tambien cuenta con para de comillas que me permiten escribir dentro, en este caso puse un "espacio" para que la ultima palabra del texto de arriba no este pegado a la primera de abajo
print ("ejemplo.")
...
print ("1" "2" "3" "3" "4" "5", sep=",")  # El parametro sep="" me permite decidir que va a haber entre medio de cada texto
print ("1", "2", "3", "3", "4", "5", sep=" ")
print ("1", "2", "3", "3", "4", "5", sep="+")
print ("1", "2", "3", "3", "4", "5", sep="-")
print ("1", "2", "3", "3", "4", "5", sep="n")
