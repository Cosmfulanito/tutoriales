...
print ("==================================================\n")
 ...
 # Modulo/resto (%) : Es el sobrante en numeros enteros que queda en una divicion de primaria. Ej: 5/2=2 y me sobra 1 
 # Numero par: Es dibisible entre 2 y su modulo/resto es igual a cero.
 # Numero impar: NO es dibisible entre 2 ya que queda un sobrante. Dando un modulo/resto igual a uno.
