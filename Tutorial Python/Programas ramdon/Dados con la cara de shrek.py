...
enter = input ('\nPrecione la tecla "enter" para tirar el dado:')     # Esto no esta conectado con nada en el codigo, es un paso extra que puse para llegar al resultado del dado. "Para que se sienta que estoy tirando los dados"
